                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        ...
                        <ul className="navbar-nav mx-md-auto mx-sm-4 flex-shrink-0 d-flex">
                            <li className="nav-item d-flex fs-5 fw-lighter text-danger-emphasis gap-4 gap-sm-0 gap-xl-5 gap-xxl-5 mb-5">
                                <Link to='/' className="nav-link text-white fw-bold" aria-current="page"><i className={"fa fa-home text-danger"}></i> Home</Link>
                                <Link to='/products' className="nav-link text-white fw-bold" href="/products"><i className={"fa fa-cart-arrow-down text-danger"}></i> Products</Link>
                                <Link to={'/profile'} className="nav-link text-white fw-bold" href="#"><i className="fa fa-user-o px-2 text-danger fs-5"></i>Profile</Link>
                                <a className="nav-link text-white" href="#"><i className={"fa fa-send text-danger"}></i> Contact us</a>
                            </li>
                        </ul>
                        <form className="search d-flex mx-2">
                            <input className="form-control h-25 my-3" type="search" placeholder="Search" aria-label="Search" />
