                    ...
                    <div className={`sidebar ${isOpen ? 'open' : ''}`} onClick={toggleSidebar}>
                        ...
                        <div className="collapse navbar-collapse" id="navbarNav">
                            ...
                            <div className="buttons d-flex">
                                <a href="/login" className="btn btn-outline-dark ms-5" type="submit"><i
                                    className="fa fa-sign-in mx-1 me-1"></i>Login</a>
                                <a href="/" className="btn btn-outline-dark ms-2" type="submit"><i
